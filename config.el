...
(map! (:leader
        (:desc "google translate" :prefix "G"
          :desc "at point"                :nv "." #'google-translate-at-point
          :desc "smooth"                 :nv "s" #'google-translate-smooth-translate
          :desc "query"  :nv "q" #'google-translate-query-translate
          :desc "query reverse"      :nv "r" #'google-translate-query-translate-reverse)))
